...
static const struct panel_ioctl_desc panel_ioctls[] = {
	...
	PANEL_IOCTL_DEF(PANEL_IOCTL_SET_OHA_STATUS, oplus_display_panel_set_oha_enable),
	PANEL_IOCTL_DEF(PANEL_IOCTL_GET_OHA_STATUS, oplus_display_panel_get_oha_enable),
	...
	PANEL_IOCTL_DEF(PANEL_IOCTL_GET_IRIS_LOOPBACK_STATUS, oplus_display_get_iris_loopback_status),
