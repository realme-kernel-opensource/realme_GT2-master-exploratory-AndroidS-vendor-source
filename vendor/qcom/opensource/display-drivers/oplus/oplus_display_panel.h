...
#define PANEL_IOCTL_SET_OHA_STATUS			  PANEL_IOW(0x33, unsigned int)
#define PANEL_IOCTL_GET_OHA_STATUS			  PANEL_IOWR(0x34, unsigned int)
...
#define PANEL_IOCTL_GET_IRIS_LOOPBACK_STATUS		PANEL_IOWR(0x5F, unsigned int)
