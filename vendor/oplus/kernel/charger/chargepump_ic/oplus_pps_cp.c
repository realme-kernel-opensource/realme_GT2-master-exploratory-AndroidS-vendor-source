...
int oplus_cp_master_get_vout(void)
{
	...
	pps_err("oplus_cp_master_get_vout--vout = %d\n", vout);
	return vout;
}
...
int oplus_cp_slave_get_vout(void)
{
	...
	pps_err("oplus_cp_slave_get_vout--vout = %d\n", vout);
	return vout;
}
...
int oplus_cp_master_get_vac(void)
{
	...
	pps_err("oplus_cp_master_get_vac--vbus = %d\n", vac);
	return vac;
}
...
int oplus_cp_slave_get_vac(void)
{
	...
	pps_err("oplus_cp_slave_get_vac--vbus = %d\n", vac);
	return vac;
}
...
int oplus_cp_slave_get_vbus(void)
{
	...
	pps_err("oplus_cp_slave_get_vbus--vbus = %d\n", vbus);
	return vbus;
}
...
int oplus_cp_master_get_ibus(void)
{
	...
	pps_err("oplus_cp_master_get_ibus--ibus = %d\n", ibus);
	return ibus;
}
...
int oplus_cp_slave_get_ibus(void)
{
	...
	pps_err("oplus_cp_slave_get_ibus--ibus = %d\n", ibus);
	return ibus;
}
...
{
	int status = 0;
	pps_err("oplus_cp_master_cp_enable,enable = %d\n", enable);
...
{
	int status = 0;
	pps_err("oplus_cp_slave_cp_enable,enable = %d\n", enable);
